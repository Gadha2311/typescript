...
function getArray() {
    ...
    return new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
        var size, _a, array, inputValues, values;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = parseInt;
                    return [4 /*yield*/, askQuestion('Enter the size of the array: ')];
                case 1:
                ...
                case 2:
                    inputValues = _b.sent();
                    values = inputValues.split(',').map(function (value) { return parseInt(value.trim(), 10); });
                    if (values.length !== size || values.some(isNaN)) {
                        console.log("Please enter ".concat(size, " valid numbers."));
                        rl.close();
                        return [2 /*return*/, resolve([])];
                    }
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getArray()];
                case 1:
                    array = _a.sent();
                    displayArray(array);
                    rl.close();
