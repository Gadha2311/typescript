...
function getArray(size, arrayName) {
    return __awaiter(this, void 0, void 0, function () {
        var array, i, rowValues, rowArray;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, askQuestion("Row ".concat(i + 1, " (space-separated): "))];
                case 2:
                    rowValues = _a.sent();
                    rowArray = rowValues.split(' ').map(function (value) { return parseFloat(value.trim()); });
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var size, _a, array1, array2, sumArray;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = parseInt;
                    return [4 /*yield*/, askQuestion('Enter the size of array: ')];
                case 1:
                    ...
                    return [4 /*yield*/, getArray(size, 'Array 1')];
                case 2:
                    array1 = _b.sent();
                    return [4 /*yield*/, getArray(size, 'Array 2')];
                case 3:
                    array2 = _b.sent();
